      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            ...
            'Profile details (phone, home area, blood type, emergency note): shown back to you in your Profile, and — for blood type and medical details below — intended to be shown to first responders during an emergency.',
            'Medical information (allergies, conditions, mobility/vision/hearing needs): entered during onboarding specifically so it can be surfaced quickly in an emergency (your Profile\'s "Medical ID" card). This is sensitive health information — it stays on-device like everything else, and only appears where you\'d expect it to (your own Profile screen).',
            'Family circle (names, relationships, phone numbers, and — if you choose to share it — a last-known-location note): used to power Call/Message/Locate actions and SOS. Locate opens a Maps search using whatever location text is on file; ResQ does not track anyone\'s live position.',
        ...
        },
        {
          ...
          body: [
            'Download my data: from Profile → Privacy & security, you can export everything ResQ has stored about you as a file, which opens your device\'s share sheet so you can save it, send it to yourself, or move it elsewhere.',
        ...
        {
          heading: '6. What changes once a backend exists',
          body: [
